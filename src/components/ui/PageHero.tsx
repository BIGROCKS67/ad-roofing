...
export function PageHero({ title, subtitle, image }: PageHeroProps) {
  return (
    <section className="relative flex h-[38vh] min-h-[260px] items-end bg-ink pt-20 sm:h-[45vh] sm:min-h-[320px] lg:h-[50vh] lg:min-h-[400px] lg:pt-24">
      <Image
        src={image}
        alt=""
        fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-8 sm:px-6 sm:pb-12 lg:px-8">
        ...
        {subtitle && (
          <p className="mt-2 max-w-2xl text-base normal-case tracking-normal text-white/75 sm:text-lg">
            {subtitle}
          </p>
        )}
      </div>
